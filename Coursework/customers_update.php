...
if(isset($_POST['submit'])) {
  ...
  $updateCustomerSQL = "UPDATE customer SET store_id = '{$store}', first_name = '{$firstName}', last_name = '{$lastName}', email = '{$email}', active = '{$active}', last_update = NOW() WHERE customer_id = '{$customerID}'";
  if(!$connection->query($updateCustomerSQL)) {
